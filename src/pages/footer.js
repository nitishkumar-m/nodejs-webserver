                ...
                <div className="row g-5">
                    ...
                    <div className="col-md-6 col-lg-3">
                        ...
                        <div className="row g-2">
                            ...
                            <div className="col-4">
                                <img className="img-fluid" src="assets/img/portfolio-2.jpg" alt="Image2"/>
                            </div>
                            <div className="col-4">
                                <img className="img-fluid" src="assets/img/portfolio-3.jpg" alt="Image2"/>
                            </div>
                            <div className="col-4">
                                <img className="img-fluid" src="assets/img/portfolio-4.jpg" alt="Image2"/>
                            </div>
                            <div className="col-4">
                                <img className="img-fluid" src="assets/img/portfolio-5.jpg" alt="Image3"/>
                            </div>
                            <div className="col-4">
                                <img className="img-fluid" src="assets/img/portfolio-6.jpg" alt="Image5"/>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-3">
